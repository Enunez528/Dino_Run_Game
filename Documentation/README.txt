...
Here I give credit for art work and audios from free websites. The audios I got from a website called Pixabay. The Images for you win screen and game over screen from the website freepik. The other images I created for controls, and start. The pistol blender model and bullet model I got from website Free 3D, and also the dinosaur model is from class files with animation. Thank you.
